        ...
        while True:
            ...
            try:
                if sstr[0] == "USER" and len(sstr) == 2:
                    ...
                    info = conmysql.list_email(user_name+"@163.com")
                    response = ""
                    for i in info:
                        response += str(i[0])
                        response += " "
                    ...
                    li_id = int(sstr[1])
                    cont = conmysql.cont_email(user_name+"@163.com",li_id)
                    if cont == -1:
                    ...
                    del_id = int(sstr[1])
                    conmysql.dele_mail(user_name+"@163.com",del_id)
                    response = "+OK!"
                    client_socket.send(response.encode("utf-8"))
